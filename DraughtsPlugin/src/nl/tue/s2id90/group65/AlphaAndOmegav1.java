 ...
 */
public class AlphaAndOmegav1  extends DraughtsPlayer {
    ...
    void alphaBeta(DraughtsNode node, int alpha, int beta) throws AIStoppedException
    {
        for  (int depth = 1;; depth++) {
            ...
            System.out.println("AlphaAndOmegav1: depth = " + depth + ", best move = " + node.getBestMove() + ", Score: " + getValue());
        }
    }
